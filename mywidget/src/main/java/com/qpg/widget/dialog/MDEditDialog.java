...
public class MDEditDialog extends BaseMDialog<MDEditDialog> implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public MDEditDialog(Builder builder) {
        ...
        mDialogView.setMinimumHeight((int) (ScreenUtil.getDisplayHeight() * builder.getMinHeight()));
        mDialog.setContentView(mDialogView);

        Window dialogWindow = mDialog.getWindow();
        WindowManager.LayoutParams lp = dialogWindow.getAttributes();
        lp.width = (int) (ScreenUtil.getDisplayWidth() * builder
                .getWidth());
