...
import com.qpg.widget.aop.trace.CheckNetTrace;
...
public class CheckNetAspect {
    ...
    @Pointcut("execution(@com.qpg.widget.aop.trace.CheckNetTrace  * *(..))")
    ...
    public void checkNet(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        if (checkNet != null) {
            if (hasInternet()) {
                ...
                ToastUtil.showCustomToast("网络未连接");
            }
        }
    }

    private boolean hasInternet() {
        ConnectivityManager cm = (ConnectivityManager) SuperWidget.getInstance().getContext()
