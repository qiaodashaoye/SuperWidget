...
public class PrefsAspect {
    ...
    @Pointcut("@within(com.qpg.widget.aop.trace.PrefsTrace)||@annotation(com.qpg.widget.aop.trace.PrefsTrace)")
    ...
    private Object prefsMethod(final ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (prefs!=null) {
            ...
            if (!"void".equalsIgnoreCase(type)) {
                ...
                AppPrefs appPrefs = AppPrefs.get(SuperWidget.getInstance().getContext());
