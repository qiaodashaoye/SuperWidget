...
public class MDSelectionDialog {
    ...
    public MDSelectionDialog(Builder builder) {
        ...
        linearLayout =dialogView.findViewById(R.id.md_mid_dialog_linear);
        mDialog.setContentView(dialogView); // 一定要在setAttributes(lp)之前才有效
        //设置dialog的宽
        Window dialogWindow = mDialog.getWindow();
        WindowManager.LayoutParams lp = dialogWindow.getAttributes();
        lp.width = (int) (ScreenUtil.getDisplayWidth() * builder.itemWidth);
    ...
    private Button getButton(String text, int position) {
        ...
        button.setPadding(ScreenUtil.dip2px(10),0,ScreenUtil.dip2px(10),0);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            onItemListener = null;
            itemHeight = ScreenUtil.dip2px(45); // 默认item高度
            itemWidth = 0.75f;
        ...
        public Builder setItemHeight(int dp) {
            this.itemHeight = ScreenUtil.dip2px(dp);
            return this;
        }
