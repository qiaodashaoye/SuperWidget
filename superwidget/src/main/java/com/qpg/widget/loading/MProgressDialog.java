...
public class MProgressDialog implements View.OnClickListener {
    ...
    private void configView() {
        ...
        myGrad.setStroke(ScreenUtil.dip2px(mBuilder.strokeWidth), mBuilder.strokeColor);
        myGrad.setCornerRadius(ScreenUtil.dip2px(mBuilder.cornerRadius));
        ...
        progress_wheel.setBarWidth(ScreenUtil.dip2px( mBuilder.progressWidth));
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            backgroundWindowColor = ContextCompat.getColor(mContext,R.color.mn_colorDialogWindowBg);
            backgroundViewColor = ContextCompat.getColor(mContext,R.color.black);
            strokeColor = ContextCompat.getColor(mContext,R.color.mn_colorDialogTrans);

            cornerRadius = 6;
            strokeWidth = 0;
            progressColor = ContextCompat.getColor(mContext,R.color.white);
            progressRimColor = ContextCompat.getColor(mContext,R.color.mn_colorDialogTrans);
            progressWidth = 2;
            progressRimWidth = 0;
