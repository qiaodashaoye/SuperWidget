...
public class ToastUtil {
    ...
    public static void showToast(Context mContext, int resId) {
        final Context context = (SuperWidget.getInstance().getContext()!= null ? SuperWidget.getInstance().getContext() : mContext);
    ...
    public static void showCustomToast(String msg) {
        showCustomToast(SuperWidget.getInstance().getContext(), msg);
    }
    ...
    public static void showCustomToast(Context mContext, String msg) {
        ...
        if (customToast == null) {
            ...
            if (SuperWidget.getInstance().getContext() != null) {
                context = SuperWidget.getInstance().getContext();
            } else {
                if (mContext != null) {
                    context = mContext;
                } else {
