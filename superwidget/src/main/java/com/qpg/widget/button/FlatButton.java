...
public class FlatButton extends AppCompatButton {
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        LayerDrawable drawableNormal =
                (LayerDrawable) getDrawable(R.drawable.selector_widget_button_normal).mutate();
        ...
        int blueDark = getColor(R.color.button_blue_pressed);
        ...
        int blueNormal = getColor(R.color.button_blue_normal);
    ...
    private Drawable createPressedDrawable(TypedArray attr) {
        GradientDrawable drawablePressed =
                (GradientDrawable) getDrawable(R.drawable.selector_widget_button_pressed).mutate();
