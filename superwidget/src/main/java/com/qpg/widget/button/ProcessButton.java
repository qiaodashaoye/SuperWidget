...
public abstract class ProcessButton extends FlatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressDrawable = (GradientDrawable) getDrawable(R.drawable.selector_widget_button_progress).mutate();
        mProgressDrawable.setCornerRadius(getCornerRadius());

        mCompleteDrawable = (GradientDrawable) getDrawable(R.drawable.selector_widget_button_complete).mutate();
        mCompleteDrawable.setCornerRadius(getCornerRadius());

        mErrorDrawable = (GradientDrawable) getDrawable(R.drawable.selector_widget_button_error).mutate();
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int purple = getColor(R.color.button_purple_progress);
